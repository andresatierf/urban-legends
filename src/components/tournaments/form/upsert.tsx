...
const formSchema = z.object({
  ...
  maxActivitiesPerDay: z.number().int().min(1).optional(),
...
export function UpsertTournamentFormDialog({
  ...
  const form = useAppForm({
    defaultValues: {
      ...
      maxActivitiesPerDay: tournament?.maxActivitiesPerDay ?? undefined,
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        >
          ...
          <FieldGroup className="max-w-[640px]">
            ...
            <form.AppField name="maxActivitiesPerDay">
              {(field) => (
                <field.NumberField
                  label="Max Activities Per Day (leave empty for unlimited)"
