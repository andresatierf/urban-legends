      ...
      {order.map((team, i) =>
        team ? (
          ...
          >
            ...
            <div className="text-mute mb-2 font-[DM_Mono] text-[1.1rem] font-medium [font-variant-numeric:tabular-nums]">
              {team.team.points}
            </div>
            <div
            ...
            >
              <span className="text-ink font-[DM_Mono] text-[0.7rem] font-medium tracking-[0.1em] opacity-70">
                {positions[i]}
              </span>
            </div>
          </div>
