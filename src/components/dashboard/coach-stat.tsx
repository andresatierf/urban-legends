  ...
  return (
    <div className="border-ink bg-card flex items-start gap-3 rounded-[14px] border-2 p-4 shadow-[3px_3px_0_var(--shadow)]">
      ...
      <div className="flex-1">
        <div className="text-mute mb-[0.2rem] font-[Lexend] text-[0.72rem] font-semibold tracking-[0.08em] uppercase">
          {label}
        </div>
        ...
        <div className="text-mute font-[Lexend] text-[0.72rem]">{sub}</div>
      </div>
    </div>
  );
}
