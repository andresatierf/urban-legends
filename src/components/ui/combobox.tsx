...
function ComboboxChip({ className, ...props }: ComboboxPrimitive.Chip.Props) {
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "bg-muted focus-within:bg-primary focus-within:text-primary-foreground flex cursor-default items-center gap-1 rounded-md px-1 ps-2 pe-0 text-xs outline-none",
        className,
      )}
      {...props}
    />
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "text-muted-foreground flex items-center justify-center text-sm not-empty:py-1",
        className,
      )}
      {...props}
    />
