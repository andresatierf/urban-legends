...
/**
 * Transform a submission with basic context into a ReviewItem
 * Used by tournament manager and other routes that have submission data
 */
...
/**
 * Transform a submission group with context into a ReviewItem
 */
